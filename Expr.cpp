...
TEST_CASE("Expressions") {
    ...
    PTR(Expr)
            let6 =
            NEW (LetExpr)(NEW (VarExpr)("x"), NEW (AddExpr)(NEW (VarExpr)("x"), NEW (NumExpr)(1)), NEW (VarExpr)("x"));
    ...
    PTR(Expr)
            let5 =
            NEW (MultExpr)(NEW (NumExpr)(5), NEW (LetExpr)(NEW (VarExpr)("x"), NEW (NumExpr)(5), NEW (VarExpr)("x")));
